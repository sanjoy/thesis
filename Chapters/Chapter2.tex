...
and consecutive addresses have a hamming distance of
$\frac{3}{2}$\footnote{For a proof, see
  \refsec{proof:average-2-flips}.}.  Both insertion sort and bubble
...
seen in \reffig{fig:total-energy-sort-algo}).
