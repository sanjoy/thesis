// This is a manually concatenated and slightly modified version of
// Google's LoopTesterApp benchmark.
...
int main(int argc, char *argv[]) {
  ...
  PRINTF("%d dummy loops\n", kDummyLoopCount);
  for (int dummyloops = 0; dummyloops < kDummyLoopCount; ++dummyloops) {
